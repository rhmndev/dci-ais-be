...
class CreateReceivingVendorDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('receiving_vendor_details');
        Schema::create('receiving_vendor_details', function (Blueprint $table) {
