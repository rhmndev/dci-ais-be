...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::put('/admin/unlock-user/{id}', 'AuthController@unlockUser');
...
// Role Material Type Routes
    ...
    Route::get('/customer', 'CustomerController@index'); // GET data customer (tabel)
    Route::get('/customer/{id}', 'CustomerController@show');
    Route::get('/customerlist', 'CustomerController@list');
    Route::get('/customersync', 'CustomerController@SyncSAP');
    Route::post('/customer', 'CustomerController@store'); // POST data customer baru (untuk QR)
